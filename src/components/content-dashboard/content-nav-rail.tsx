/**
 * ContentNavRail - Left navigation for Content Dashboard subsections.
 * Pipeline, Library, Master (content-specific overview).
 */
...
const STORAGE_KEY = 'lifeops_content_nav_collapsed'
...
export function ContentNavRail() {
  ...
  const basePath = '/dashboard/content'
